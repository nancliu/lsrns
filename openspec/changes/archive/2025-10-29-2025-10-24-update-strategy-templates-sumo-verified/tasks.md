...
- [x] 1.1.1 Regenerate `templates/control_strategies/variable_speed_sign/vss_moderate.json`
...
- [x] 1.1.2 Regenerate `vss_strict.json`
...
- [x] 1.1.3 Add new template: `vss_weather_based.json` (weather-based progressive limiting)
...
- [x] 1.1.4 Add new template: `vss_upstream_warning.json` (upstream preemptive slowdown)
...
- [x] 1.1.5 Add new template: `vss_lane_differentiated.json` (per-lane speed control)
...
- [x] 1.2.1 Regenerate `templates/control_strategies/dynamic_hard_shoulder/dhs_peak_hours.json`
...
- [x] 1.2.2 Validate lane indexing

  - Confirm lane 3 is rightmost for 4-lane highways
  - Document lane indexing convention in template description
- [x] 1.2.3 Add new template: `dhs_passenger_only.json` (passenger-only hard shoulder)
...
- [x] 1.2.4 Add new template: `dhs_peak_multi_interval.json` (complex multi-interval management)
...
- [x] 1.3.1 Regenerate `tec_entrance_close.json`
...
- [x] 1.3.2 Regenerate `tec_truck_ban.json`
...
- [x] 1.3.3 Create new template: `tec_metering.json` (flow control)
...
- [x] 1.3.4 Add new template: `tec_metering_advanced.json` (time-varying ramp metering)
...
- [x] 1.3.5 Add new template: `tec_truck_ban.json` (truck restriction during peak hours)
...
- [x] 1.3.6 Add new template: `tec_closure_complete.json` (full entrance blockage)
...
- [x] 1.4.1 Create/update `templates/control_strategies/templates_index.json`
  ```json
  {
    "templates": [
...
- [x] 2.1.1 Create `shared/control_tools/parameter_validator.py`
...
- [x] 2.1.2 Implement constraint validation
...
- [x] 2.1.3 Implement unit conversion functions
...
- [x] 2.1.4 Implement SUMO-specific validation
...
- [x] 2.2.1 Update `shared/control_tools/template_parser.py`
...
- [x] 2.3.1 Add validation routes to `api/routes/control_strategy_routes.py`
...
- [x] 2.3.2 Add XML preview endpoint
...
- [x] 3.1.1 Enhance `shared/control_tools/additional_generator.py`
...
- [x] 3.1.2 VSS XML generation with speed steps
  ...
  - Function: `generate_vss_xml(strategy) -> str`
    ...
    - Example output:
      ...
      ```
- [x] 3.1.3 DHS XML generation with lane indices
...
- [x] 3.1.4 TEC XML generation with flow control
...
- [x] 3.1.5 Add XML validation after generation
...
- [x] 4.1.1 Create `frontend/control/js/parameter_form.js`
...
- [x] 4.1.2 Implement parameter control rendering
...
- [x] 4.1.3 Add time interval picker component
...
- [x] 4.1.4 Add speed steps editor (VSS)
...
- [x] 4.1.5 Add flow interval editor (TEC)
...
- [x] 4.2.1 Implement real-time validation
...
- [x] 4.2.2 Add constraint violation messages
...
- [x] 4.2.3 Implement form submission validation
...
- [x] 4.3.1 Create XML preview panel
...
- [x] 4.3.2 Implement XML preview generation
...
- [x] 5.1.1 Create `tests/unit/test_parameter_validator.py`
...
- [x] 5.1.2 Create `tests/unit/test_template_parser.py`
...
- [x] 5.1.3 Create `tests/unit/test_additional_generator_v2.py`
...
- [x] 5.1.4 Create `tests/unit/test_api_validation_endpoints.py`
...
- [x] 5.2.1 Create `tests/unit/frontend/test_parameter_form.js` (if using Jest)
...
- [x] 5.3.1 Create `tests/integration/test_strategy_template_workflow.py`
...
- [x] 5.3.2 Test parameter validation chain
...
- [x] 5.4.1 Create `tests/e2e/test_strategy_parameter_configuration.spec.js`
...
- [x] 5.4.2 Test form interactivity
...
- [x] 5.5.1 Test parameter validation performance

  - Validate 100 parameters: Target <200ms
  - Generate XML preview: Target <150ms
- [x] 5.5.2 Test form generation performance
...
- [x] 6.1.1 Update template documentation
...
- [x] 6.3.1 Update development guide with template updates

  - Explain v1.0 vs v2.0 templates
  - Document backward compatibility approach
  - Show how to add new templates
- [x] 6.3.2 Document parameter validator usage
...
- [x] All 5 templates regenerated with v2.0 schema including SUMO mappings
- [x] Parameter validator handles all parameter types correctly
- [x] Unit conversion (hours→seconds, km/h→m/s) works correctly
- [x] Form generation creates proper controls for each parameter type
- [x] Real-time validation shows errors/warnings while typing
- [x] XML preview displays during strategy configuration
- [x] All unit tests pass (>90% coverage for validator module)
- [x] All E2E tests pass (template → form → XML workflow)
- [x] Backward compatibility: v1.0 strategies still loadable
- [x] Performance: Form generation <100ms, validation <200ms, XML generation <150ms
- [x] API documentation updated with new endpoints
- [x] No type errors or linting warnings

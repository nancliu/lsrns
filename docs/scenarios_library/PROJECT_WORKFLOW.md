...
├── 01_交通事故/
│   ├── vss/                          # VSS动态限速
│   │   ├── scenario_accident_vss_12547.json
│   │   └── scenario_accident_vss_12565.json
│   ├── dhs/                          # DHS应急车道
│   │   └── scenario_accident_dhs_12575.json
│   └── tec/                          # TEC收费管控
│       └── (暂无)
├── 02_交通阻塞_流量激增/
│   ├── vss/
│   │   └── scenario_congestion_vss_12837.json
│   ├── dhs/
│   │   └── scenario_congestion_dhs_12853.json
│   └── tec/
│       └── scenario_congestion_tec_12629.json
├── 03_交通管制/
│   ├── vss/
│   ├── dhs/
│   └── tec/
│       ├── scenario_control_tec_12637.json
│       └── scenario_control_tec_13229.json
├── 04_地质灾害/
│   └── tec/
│       └── scenario_disaster_tec_13470.json
├── 05_车辆故障_危化品/
│   ├── vss/
│   └── tec/
└── 06_恶劣天气_暴雨/
    ├── vss/
    │   └── scenario_weather_vss_13270.json
    └── tec/
```
